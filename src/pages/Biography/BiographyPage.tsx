...
import { Carousel, LinkRouter, Transition } from 'components';

import NewtonImage from 'img/biography/0.jpg';
import NewtonImage2 from 'img/biography/2.jpg';
import NewtonImage3 from 'img/biography/3.jpg';
import NewtonImage4 from 'img/biography/4.jpg';
import NewtonImage5 from 'img/biography/5.jpg';
import NewtonImage6 from 'img/biography/6.jpg';
import NewtonImage7 from 'img/biography/7.jpg';
import NewtonImage8 from 'img/biography/8.jpg';
import NewtonImage9 from 'img/biography/9.jpg';

const images: { id: number; active?: boolean; src: string }[] = [
  { id: 0, src: NewtonImage, active: true },
  { id: 1, src: NewtonImage2 },
  { id: 2, src: NewtonImage3 },
  { id: 3, src: NewtonImage4 },
  { id: 4, src: NewtonImage5 },
  { id: 5, src: NewtonImage6 },
  { id: 6, src: NewtonImage7 },
  { id: 7, src: NewtonImage8 },
  { id: 8, src: NewtonImage9 },
];
